...
$(document).on("click", "#signUp", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var firstname, lastname, address, email, password, confirmPassword, phone, result;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (!(firstname == "" || lastname == "" || address == "" || email == "" || password == "" || confirmPassword == "" || phone == "")) {
              _context.next = 10;
              break;
            }

            return _context.abrupt("return", alert("Please provide all the information"));
          ...
          case 10:
            ...
            return _context.abrupt("return", alert("Passwords do not match"));
          ...
          case 19:
            ...
            if (_context.t0.response.data.message.includes("duplicate key error")) {
              alert("Email already in use.");
            } else if (_context.t0.response.data.message.includes("Cast to Number failed")) {
              alert("Phone number cannot be text");
            } else alert(_context.t0.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", alert("Please provide your email and password"));
...
$(document).on("click", "#reservebook", /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
    var userId, bookId, result;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return _context4.abrupt("return", alert("Something went wrong. Please try again later"));

          case 6:
            _context4.next = 8;
            return (0, _axios.default)({
              method: "POST",
              url: "http://localhost:8000/api/v1/book-issue/book/".concat(bookId, "/user/").concat(userId)
            });
...
$(document).on("click", "#removereservation", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "DELETE",
              url: "http://localhost:8000/api/v1/book-issue/".concat(issueId)
            });
...
$(document).on("click", "#loginAdmin", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return _context6.abrupt("return", alert("Please provide email and password"));
...
$(document).on("click", "#logoutAdmin", /*#__PURE__*/function () {
...
$(document).on("click", "#updateStock", /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(e) {
    var bookId, newStock, result;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            return _context8.abrupt("return", alert("Please provide an quantity"));
          ...
          case 5:
            ...
            return (0, _axios.default)({
              ...
              url: "http://localhost:8000/api/v1/books/".concat(bookId)
            });
...
$(document).on("click", "#addbook", /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(e) {
    var name, authors, category, publishedDate, quantity, details, image, authorArr, filteredArr, form, result;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            if (!(name === "" || authors === "" || category === "" || publishedDate === "" || quantity === "")) {
              _context9.next = 11;
              break;
            }

            return _context9.abrupt("return", alert("Please fill all the fields"));
          ...
          case 11:
            ...
            return _context9.abrupt("return", alert("Quantity should greater than 1"));

          case 13:
            authorArr = authors.split(",");
            filteredArr = [];
            authorArr.forEach(function (auth) {
              if (auth.trim() !== "") {
          ...
          case 31:
            ...
            if (!_context9.t0.response.data.message.includes("duplicate key error")) {
              _context9.next = 35;
              break;
            }

            return _context9.abrupt("return", alert("Book under this name has already been added"));
...
$(document).on("click", "#pickedup", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://localhost:8000/api/v1/book-issue/issue/".concat(issueId)
            });
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://localhost:8000/api/v1/book-issue/".concat(issueId, "/return/").concat(bookId)
            });
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          case 0:
            ...
            return _context12.abrupt("return", alert("Please provide fine amount"));
...
$(document).on("click", "#filter", function (e) {
  e.preventDefault(); // const status = $("input[name='isActive']:checked");
  ...
  filters.forEach(function (el, i) {
    if (i + 1 === filters.length) filterString += "status=".concat(el);else filterString += "status=".concat(el, "&");
  });
  var userEmail = $("#searchValue").val();
  if (userEmail !== "" && filterString === "") filterString += "email=".concat(userEmail);else if (userEmail !== "" && filterString !== "") filterString += "&email=".concat(userEmail);
  window.location.replace("/admin/dashboard/book-issues?".concat(filterString));
});
var bookToBeIssuedByAdmin = "";
var bookToBeIssuedToUser = "";
...
$(document).on("click", "#getuserdetail", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          case 0:
            ...
            return _context13.abrupt("return", alert("Please enter your email"));
          ...
          case 7:
            ...
            if (res.data.user) {
              ...
              $("#user-detail").html("<p> Name: ".concat(res.data.user.name.toUpperCase(), " </p>\n          <p> Address: ").concat(res.data.user.address.toUpperCase(), "</p> \n          <button class=\"btn btn-default\" id=\"confirmIssue\">CONFIRM</button>\n          "));
            } else {
          ...
          case 12:
            return _context13.abrupt("return", alert("Invalid credentail"));
...
$(document).on("click", "#confirmIssue", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context14.prev = _context14.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "http://localhost:8000/api/v1/book-issue/issue/admin/".concat(bookToBeIssuedByAdmin),
              data: {
          ...
          case 8:
            ...
            // console.log(error);
            alert(_context14.t0.response.data.message);
